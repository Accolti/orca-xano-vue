...
function Valor_Venda_ML {
  ...
  stack {
    ...
    function.run "" {
      input = {
        comprimento_ou_area: $input.Area_do_Cliente
        largura            : 0
        largura_fixa       : 0
        tam_rolo           : 0
        valor_custo_tabela : 0
        tipo_preco         : ""
        fator_corte        : 0
      }
    } as $func1
    ...
    function.run fCalculaFrete {
      input = {valor_total_compra: $Valor_Custo_Ml}
    } as $freteB2B
  ...
  guid = "YiCMT6wHgheM6zg6qu7-McE3sdY"
}