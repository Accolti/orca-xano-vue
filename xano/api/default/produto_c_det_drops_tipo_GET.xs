...
query produto_C_Det_drops_tipo verb=GET {
  api_group = "Default"
  auth = "User"
  ...
  stack {
    ...
    db.query Produto {
      ...
      where = $db.Produto.detalhe_id > 0 && $db.Material.id ==? $input.material_id && $db.Produto.tipo_id > 0
      eval = {
  ...
  response = $Produto_1
  guid = "WxBMo0tlgusBMIMaUd2i0qoTz7I"
}